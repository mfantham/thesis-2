...
\subsection{Labelling the cytoskeleton reveals cellular structure} \label{sec:cytoskeleton}
...
SIM is a microscopy technique which generates images in the niche between STORM/STED, which provide \SI{20}{\nano\metre} resolution but take \SI{5}{\minute} or more per acquisition; and widefield microscopy, which can image at 100\,frames per second but at a diffraction limited resolution of about \SI{200}{\nano\metre}. 
...
An important aim for LAG SIM was that any research should be able to use it, with minimal training required for capturing and reconstructing SIM data. 
...
Whilst this data is information-rich and exciting to explore in detail, transferring it for remote colleagues to evaluate is problematic due to large file sizes, and complicated and expensive analysis software. 
...
It has recently been discovered that proteins within the ER move with directly flow, rather than diffusive motion which was previously assumed. 
...
High-speed videos revealed the ER membrane pinching at a high frequency, which was hypothesised to cause a peristaltic flow. 
