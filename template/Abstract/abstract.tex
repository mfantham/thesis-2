...
\begin{abstract}
This work details the development of two tools, LAG SIM and FPBioimage, and demonstrates their application to answering biological questions about utilising MOFs for drug delivery and discovering a new mechanism for luminal ER transport.
...
The large pore size of these crystalline materials allows them to be loaded with drugs which would otherwise be degraded in extracellular space, for example siRNA or DCA. 
