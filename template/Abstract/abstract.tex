...
However, such advanced instruments typically require expert engineers and physicists to operate them, limiting their throughput and application to biological problems. 
...
The microscope's ease-of-use led to a wide variety of biological studies, which are presented as case studies to assist readers of this thesis to design their own SIM experiments. 
...
The open-source license under which the software is distributed means that developers can continue to build on the programs, extending their capabilities as new technology becomes available. 
