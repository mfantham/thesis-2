...
\end{subfigure}
\caption[LAG SIM: Structured illumination can be used to computationally remove out of focus light]{(a) show a widefield image, $W$. (b) shows the same image, but with out of focus light removed by the square-law detection of Equation~\ref{eq:wilson-square-law}, so that just the $Wm$ term in Proofs~\ref{pro:square} and \ref{pro:homo} remains. Images show cells infected with Herpes virus, prepared by Katharina Scherer. Scalebar is \SI{10}{\micro\metre}. }
\label{fig:os-sim-comparison}
\end{figure}
...
\begin{subfigure}[b]{0.49\textwidth}
	\includegraphics[width=\textwidth]{microscope-OTF}\vspace{-16pt}
	\caption{}\label{fig:microscope-OTF}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.49\textwidth}
	\includegraphics[width=\textwidth]{sim-OTF-peaks}\vspace{-16pt}
	\caption{}\label{fig:OTF-sim-peaks}
\end{subfigure} \vspace{-16pt}

~\newline
\begin{subfigure}[b]{0.49\textwidth}
	\includegraphics[width=\textwidth]{wiener-no-apo}\vspace{-16pt}
	\caption{}\label{fig:wiener-no-apo}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.49\textwidth}
	\includegraphics[width=\textwidth]{wiener-plus-apo}\vspace{-16pt}
...
If the meridional plane is defined at an angle of $\phi=0\si{\degree}$ around the optical axis, aligned with the back-aperture spots when the SLM is showing a vertical SIM grating pattern, the incident light should be linearly polarised at $\phi=90\si{\degree}$ to ensure s-polarised light. 
...
%DO I WANT TO DRAW AN IMAGE OF THIS??? :( yeah :( Do it on autocad.. 
...
Firstly, the device is able to provide a full \SI{360}{\degree} polarisation rotation, more than adequate for the \SI{\pm60}{\degree} required to align polarisation with the SIM pattern orientations. 
...
%% I THINK I NEED TO SORT OUT APODISATION STUFF WHILE CLEMENS LOOKS AT THE REST OF THE WORK. BECAUSE LOWER a MEANS MORE APODISATION AT THE MOMENT, WHICH CAN ACTUALLY BE SEEN!!! 
...
\end{tabular}
 ...
 %so Hessian de-noising was performed in MATLAB after the reconstruction. 
