...
If the meridional plane is defined at an angle of \SI{0}{\degree} around the $\phi$ axis, aligned with the back-aperture spots when the SLM is showing a vertical SIM grating pattern, the incident light should be linearly polarised at $\phi=90\si{\degree}$ to ensure s-polarised light. 
...
%DO I WANT TO DRAW AN IMAGE OF THIS??? :( yeah :( 
...
\begin{table}
\caption[LAG SIM: Resolution improvement for different lenses, wavelengths, and SLM grating patterns]{\label{tab:resolution}The table shows the different resolution improvement} %TODO make better
\centering
...
%TODO add a paragraph on resolution improvement
