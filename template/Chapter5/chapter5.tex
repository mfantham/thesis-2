...
These characteristically flat cells, with a height of <\SI{\sim 10}{\micro\meter}, % Check and cite this?
...
Furthermore, the binary threshold required for each image set varies depending on exposure time, laser power, and expression of the fluorescent label that particular cell. 
